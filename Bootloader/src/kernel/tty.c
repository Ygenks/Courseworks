		...
		if (*fmt == '%') {
			...
			switch (*fmt) {
				...
				case 'c':
					...
					break;
				case 's':
					out_string((char*)arg, true);
					break;
				case 'b':
					out_string(int_to_str(arg, 2), true);
					break;
				case 'o':
					out_string(int_to_str(arg, 8), true);
					break;
				case 'd':
					out_string(int_to_str(arg, 10), true);
					break;
				case 'x':
					out_string(int_to_str(arg, 16), true);
					break;
			}
		} else {
			out_char(*fmt, true);
